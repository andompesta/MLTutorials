...
def __pars_args__():
    ...
    parser.add_argument("-v", "--version", type=str, default="v-deadly", help="Model version")
...
if __name__ == '__main__':
    ...
    env = VizdoomEnv(path.join("RL", "doom_setup", "deadly_corridor"), args.show_window, len(args.actions))
